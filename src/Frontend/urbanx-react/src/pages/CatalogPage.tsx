        ...
        const fetchProducts = async () => {
            ...
            try {
                ...
                const mockProducts: Product[] = [
                    { id: '1', name: 'Premium Wireless Headphones', price: 299, category: 'headphones', imageUrl: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=500&q=80', description: 'Experience studio-quality sound with our premium wireless headphones.', merchantId: 'm1', inventoryCount: 10 },
                    { id: '2', name: 'Minimalist Ceramic Vase', price: 45, category: 'home', imageUrl: 'https://images.unsplash.com/photo-1581783898377-1c85bf937427?w=500&q=80', description: 'A sleek, modern vase for any contemporary home.', merchantId: 'm1', inventoryCount: 5 },
                    { id: '3', name: 'Smart Fitness Tracker', price: 129, category: 'electronics', imageUrl: 'https://images.unsplash.com/photo-1575311373937-040b8e1fd5b6?w=500&q=80', description: 'Track your fitness goals with precision and style.', merchantId: 'm2', inventoryCount: 20 },
                    { id: '4', name: 'Luxury Leather Watch', price: 199, category: 'watches', imageUrl: 'https://images.unsplash.com/photo-1524592094714-0f0654e20314?w=500&q=80', description: 'A timeless piece of craftsmanship for your wrist.', merchantId: 'm2', inventoryCount: 8 },
                    { id: '5', name: 'Portable Bluetooth Speaker', price: 89, category: 'electronics', imageUrl: 'https://images.unsplash.com/photo-1608156639585-34a0a56ee6c9?w=500&q=80', description: 'Room-filling sound in a compact, portable design.', merchantId: 'm1', inventoryCount: 15 },
                    { id: '6', name: 'Organic Cotton Throw', price: 65, category: 'home', imageUrl: 'https://images.unsplash.com/photo-1580302200322-22443015403e?w=500&q=80', description: 'Soft, breathable throw made from 100% organic cotton.', merchantId: 'm3', inventoryCount: 12 },
                ];
