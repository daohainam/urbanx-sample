            ...
            <div className="flex flex-col md:flex-row gap-12">
                ...
                <aside className="w-full md:w-64 flex-shrink-0">
                    <div className="bg-white rounded-lg border border-gray-100 shadow-sm p-6 mb-8 text-center">
                        ...
                        <h2 className="font-serif font-bold text-lg text-gray-900">{user.name}</h2>
                    ...
                    <nav className="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden">
                        ...
                        <button className="w-full flex items-center gap-3 px-6 py-4 text-sm font-medium text-red-500 hover:bg-red-50 transition-colors border-l-4 border-l-transparent text-left">
                            <LogOut size={18} />
                            <span>Sign Out</span>
                        </button>
                    </nav>
                ...
                <main className="flex-1">
                    <div className="bg-white rounded-lg border border-gray-100 shadow-sm p-8">
                        <h1 className="text-2xl font-serif font-bold text-gray-900 mb-2">Hello, {user.name.split(' ')[0]}!</h1>
